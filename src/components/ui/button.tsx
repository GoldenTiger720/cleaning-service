  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Cleaning company specific variants
        hero: "bg-gradient-hero text-white font-semibold shadow-glow hover:shadow-strong hover:scale-105 transition-bounce",
        ...
        glass: "glass backdrop-blur-sm bg-white/10 text-white border-white/20 hover:bg-white/20 shadow-soft",
        premium: "bg-gradient-primary text-white font-semibold shadow-medium hover:shadow-strong hover:scale-102 transition-smooth",
      },
      size: {
